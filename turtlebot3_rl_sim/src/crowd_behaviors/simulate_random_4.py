    ...
    def moving_1(self):
        ...
        while True:
            ...
            if elapsed_time > 2.25:  # Default: 2.25, 0.5
                ...
                self.move_model('obstacle_4', self.model_4_pose, random_vel_x[0], random_vel_y[0], 0)
                self.move_model('obstacle_5', self.model_5_pose, random_vel_x[1], random_vel_y[1], 0)
                self.move_model('obstacle_9', self.model_9_pose, random_vel_x[2], random_vel_y[2], 0)
                self.move_model('obstacle_11', self.model_11_pose, random_vel_x[3], random_vel_y[3], 0)
