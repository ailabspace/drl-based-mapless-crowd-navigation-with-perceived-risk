    ...
    def moving_1(self):
        ...
        while True:
            ...
            if elapsed_time > 0.5:  # Default: 2.25, 0.5
                ...
                self.move_model('obstacle_1', self.model_1_pose, speed, speed, 0)
                self.move_model('obstacle_2', self.model_2_pose, speed, speed, 0)
                self.move_model('obstacle_3', self.model_3_pose, speed, speed, 0)
                self.move_model('obstacle_4', self.model_4_pose, speed, speed, 0)
                self.move_model('obstacle_5', self.model_5_pose, speed, 0, 0)
                self.move_model('obstacle_6', self.model_6_pose, speed, speed, 0)
                self.move_model('obstacle_7', self.model_7_pose, speed, -speed, 0)
                self.move_model('obstacle_8', self.model_8_pose, speed, -speed, 0)
                self.move_model('obstacle_9', self.model_9_pose, speed, -speed, 0)
                ...
                self.move_model('obstacle_14', self.model_14_pose, speed, -speed, 0)
                self.move_model('obstacle_15', self.model_15_pose, speed, -speed, 0)
                self.move_model('obstacle_16', self.model_16_pose, speed, 0.0, 0)
                self.move_model('obstacle_17', self.model_17_pose, speed, speed, 0)
                self.move_model('obstacle_18', self.model_18_pose, speed, 0.0, 0)
