    ...
    def moving_1(self):
        ...
        while True:
            ...
            if elapsed_time > 0.5:  # Default: 2.25, 0.5
                ...
                self.move_model('obstacle_1', self.model_1_pose, 0.1, 0.1, 0)
                self.move_model('obstacle_2', self.model_2_pose, 0.0, 0.1, 0)
                self.move_model('obstacle_3', self.model_3_pose, 0.0, 0.1, 0)
                self.move_model('obstacle_4', self.model_4_pose, 0.1, 0.1, 0)
                self.move_model('obstacle_5', self.model_5_pose, 0, 0.1, 0)
                self.move_model('obstacle_6', self.model_6_pose, -0.1, 0.1, 0)
                self.move_model('obstacle_7', self.model_7_pose, 0.0, -0.1, 0)
                self.move_model('obstacle_8', self.model_8_pose, -0.1, -0.1, 0)
                self.move_model('obstacle_9', self.model_9_pose, 0, -0.1, 0)
                self.move_model('obstacle_10', self.model_10_pose, 0.0, -0.1, 0)
                self.move_model('obstacle_11', self.model_11_pose, 0, -0.1, 0)
